...
public class CuboidUtils implements Cloneable, ConfigurationSerializable, Iterable<Block> {

    protected String worldName;
    protected final Vector minimumPoint, maximumPoint;

    public CuboidUtils(CuboidUtils cuboid) {
    ...
    public CuboidUtils(Location loc1, Location loc2) {
    ...
    public CuboidUtils(String worldName, double x1, double y1, double z1, double x2, double y2, double z2) {
    ...
    @Override
    public CuboidUtils clone() {
        return new CuboidUtils(this);
    }
    ...
    public static CuboidUtils deserialize(Map<String, Object> serializedCuboid) {
        try {
